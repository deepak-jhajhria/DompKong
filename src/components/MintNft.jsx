            ...
            <div className='container max-w-[1140px]'>
                <div className="grid grid-cols-1 lg:grid-cols-2 pt-10 sm:pt-14 md:pt-16 lg:pt-[164px] sm:pb-6 md:pb-8 lg:pb-12 items-center w-full">
                    <div className=' flex justify-center'>
                        <Image className=" max-sm:max-w-32 max-lg:max-w-44" src={MIntBg} alt='MintWishky' />
                    ...
                    <div className='flex w-full max-lg:mt-8 justify-center'>
                        <div className='flex flex-col max-w-[600px] lg:max-w-[494px] w-full'>
                            <h2 className='text-white font-azo font-normal leading-8 md:leading-[69px] text-3xl sm:text-4xl md:text-5xl lg:text-[64px] uppercase mt-5'>Mint NFT</h2>
                            ...
                            <div className="mt-4 sm:mt-5 md:mt-6 lg:mt-9 w-full flex">
