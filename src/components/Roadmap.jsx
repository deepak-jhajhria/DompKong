...
const Roadmap = () => {
    return (
        <div className=" container max-w-[1140px] mt-2 pb-6 xl:pb-0">
            <h2 className="text-white text-center font-azo text-[50px] sm:text-[64px] font-normal pt-4 md:pt-10 lg:pt-16 xl:pt-[84px] pb-2 sm:pb-7 lg:pb-10 xl:pb-[71px]">Roadmap</h2>
            <div className="min-h-[558px] flex flex-wrap justify-center">
                ...
                <div className="w-full xl:w-[64%] relative flex flex-col gap-6">
                    <div className="flex items-center xl:max-w-[903px] xl:absolute xl:top-[0] xl:left-[-24%] group">
                        <RoadmapLineIcon />
                        <div className=" w-12 md:w-[76px] h-12 sm:h-[76px] bg-white text-black font-Montserrat text-sm md:text-base sm:text-lg lg:text-xl font-black rounded-[50%] flex justify-center items-center xl:ml-2 mr-4 sm:mr-6 md:mr-8 xl:mr-[43px] shrink-0 group-hover:bg-[#FDDA60] group-hover:shadow-[0px_4px_21px_rgba(253,218,96,0.70)] duration-300">20%</div>
            ...
            <div className="flex justify-center mt-14 mb-[121px]">
