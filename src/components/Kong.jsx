            ...
            <div className='grid grid-cols-1 sm:grid-cols-4 w-full mx-auto gap-6 relative'>
                ...
                <div className='col-span-1'>
                    <div className='flex sm:flex-col justify-around max-xs:pt-12 max-sm:pt-14'>
                        ...
                        <div data-aos="fade-right" data-aos-duration="2000" className='sm:flex sm:justify-start sm:mt-[35px]'>
                ...
                <div className='col-span-1'>
                    <div className="flex sm:flex-col justify-around max-sm:pb-5">
                        ...
                        <div data-aos="fade-left" data-aos-duration="2000" className='sm:flex sm:justify-end  sm:mt-[35px]'>
                            <Image onClick={() => tabChange("tab11")} className='sm:translate-x-7 border xs:border-[2px] sm:border-[4px] border-[#FDDA60] rounded-full sm:rounded-lg shadow-[0_1px_5px_2px_rgba(253,218,96,20.88)] sm:shadow-[0_1px_15px_2px_rgba(253,218,96,20.88)] max-xs:max-w-[45px] max-sm:max-w-[60px] max-md:max-w-[80px] max-lg:max-w-[100px] max-xl:max-w-[140px]' src={Kong10} alt='Kong' />
                        </div>
                    </div>
                </div>
            </div>
