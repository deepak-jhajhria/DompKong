...
const Header = () => {
    return (
        <div className='bg-[url(../assets/image/headerBGImage.webp)] z-50 bg-cover bg-center w-full relative xs:min-h-[500px] sm:min-h-[600px] md:min-h-[700px] lg:min-h-[810px] overflow-hidden'>
            ...
            <Image className=" absolute top-0 left-0 z-10 max-xl:w-[40%]" src={LeftBel} alt="Left Bel"/>
            <Image className=" absolute top-0 right-0 z-10 max-xl:w-[40%]" src={Rightbel} alt="right Bel"/>
            <Image className=" absolute bottom-0 right-0 z-20 max-xl:w-[45%] translate-x-[47%]" src={whiteGorila} alt="white-gorila"/>
            <Image className=" absolute bottom-0 right-[9%] z-10 max-xl:w-[30%]" src={SaudiGorila} alt="saudi-gorila"/>
            <Image className=" absolute bottom-0 right-[30%] z-10 max-xl:w-[30%]" src={BlackGorila} alt="Black-gorila"/>
