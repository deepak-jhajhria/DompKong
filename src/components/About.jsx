...
const About = () => {
    return (
        <div className='container max-w-[1140px] relative flex pt-7 sm:pt-10 md:pt-16 lg:pt-[100px] xl:pt-[220px] pb-10 sm:pb-[50px] md:pb-[80px] xl:pb-[100px] overflow-hidden'>
            ...
            <div data-aos="fade-right" data-aos-duration="2000" className=' absolute right-0 top-0 -z-10'><AboutSecEllipse /></div>
        </div>
    )
}
